...
import { Home, User, Compass, Award, Mail, Menu, X, Terminal, Sun, Moon } from 'lucide-react';
...
const Header = () => {
  ...
  const navLinks = [
    ...
    { name: isZh ? '关于' : 'About', path: '/about', icon: <User className="w-4 h-4" /> },
    { name: isZh ? '探索' : 'Exploration', path: '/exploration', icon: <Compass className="w-4 h-4" /> },
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-slate-900/85 backdrop-blur-md border-b border-slate-800">
